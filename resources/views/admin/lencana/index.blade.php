                                                    ...
                                                    <form class="form-submit" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            <input type="number" class="form-control" name="target"
                                                                placeholder="Target">
                                                            <span class="error invalid-feedback target_error"></span>
                                                        </div>
                                                            ...
                                                            <div class="input-group">
                                                                <div class="custom-file">
                                                                    <input type="file" name="icon"
                                                                        class="custom-file-input" accept=".png, .jpg, .jpeg"
                                                                        id="icon">
                                                                    <label class="custom-file-label" for="icon">example
                                                                        image.jpg</label>
                                                                </div>
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">Upload</span>
                                                                </div>
                                                                <span class="error invalid-feedback icon_error"></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button"
                                                                data-url="{{ route('admin.add-data-lencana') }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->target }}</td>
                                                <td><img src="{{ asset('public/icon/' . $item->icon) }}" width="100x"
                                                        height="100px" alt=""></td>
                                                <td>
                                                                    ...
                                                                    <form class="form-submit" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <input type="number" class="form-control"
                                                                                name="target" placeholder="Mata Pelajaran"
                                                                                value="{{ $item->target }}">
                                                                            <span
                                                                                class="error invalid-feedback target_error"></span>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="icon">Icon</label>
                                                                            <div class="input-group">
                                                                                ...
                                                                                <span
                                                                                    class="error invalid-feedback icon_error"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-dismiss="modal">Close</button>
                                                                            <button type="button"
                                                                                data-url="{{ route('admin.edit-data-lencana', ['params' => $item->uuid]) }}"
                                                                                class="btn btn-primary submit-form">Save</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                    ...
                                                    <button class="btn btn-danger btn-sm button-delete"
                                                        data-url="{{ route('admin.deleted-data-lencana', ['params' => $item->uuid]) }}">
