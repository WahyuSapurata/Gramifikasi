                                                    ...
                                                    <form class="form-submit">
                                                        ...
                                                        <div class="mb-3">
                                                            <input type="text" class="form-control" name="misi"
                                                                placeholder="Misi">
                                                            <span class="error invalid-feedback misi_error"></span>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button"
                                                                data-url="{{ route('admin.add-data-misi') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                    ...
                                                                    <form class="form-submit">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <input type="text" class="form-control"
                                                                                name="misi" placeholder="Misi"
                                                                                value="{{ $item->misi }}">
                                                                            <span
                                                                                class="error invalid-feedback misi_error"></span>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary"
                                                                                data-dismiss="modal">Close</button>
                                                                            <button type="button"
                                                                                data-url="{{ route('admin.edit-data-misi', ['params' => $item->uuid]) }}"
                                                                                class="btn btn-primary submit-form">Save</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                    ...
                                                    <button class="btn btn-danger btn-sm button-delete"
                                                        data-url="{{ route('admin.deleted-data-misi', ['params' => $item->uuid]) }}">
