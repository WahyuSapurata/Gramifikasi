                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="form-submit">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="error invalid-feedback kategori_error"></span>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button"
                                                                data-url="{{ route('admin.add-data-kategori') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                    ...
                                                                    <form class="form-submit">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ $item->kategori }}">
                                                                            <span
                                                                                class="error invalid-feedback kategori_error"></span>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary"
                                                                                data-dismiss="modal">Close</button>
                                                                            <button type="button"
                                                                                data-url="{{ route('admin.edit-data-kategori', ['params' => $item->uuid]) }}"
                                                                                class="btn btn-primary submit-form">Save</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                    ...
                                                    <button class="btn btn-danger btn-sm button-delete"
                                                        data-url="{{ route('admin.deleted-data-kategori', ['params' => $item->uuid]) }}">
