                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="form-submit">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button"
                                                                data-url="{{ route('admin.add-data-guru') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                    ...
                                                                    <form class="form-submit">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ $item->nip }}">
                                                                            <span
                                                                                class="error invalid-feedback nip_error"></span>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-dismiss="modal">Close</button>
                                                                            <button type="button"
                                                                                data-url="{{ route('admin.edit-data-guru', ['params' => $item->uuid]) }}"
                                                                                class="btn btn-primary submit-form">Save</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                    ...
                                                    <button class="btn btn-danger btn-sm button-delete"
                                                        data-url="{{ route('admin.deleted-data-guru', ['params' => $item->uuid]) }}">
