                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Data Gramifikasi</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form action="{{ route('guru.data-soal') }}" method="GET">
                                <div class="card-body">
                                    <div class="mb-2">
                                ...
                                <div>
                                    <div class="d-flex justify-content-between">
                                        @php
                                            ...
                                            $isDisabled = $total_point >= 100 || !request()->has('uuid_misi');
                                        @endphp
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="form-submit">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button"
                                                                data-url="{{ route('guru.add-data-soal') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                    ...
                                                                    <form class="form-submit">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-dismiss="modal">Close</button>
                                                                            <button type="button"
                                                                                data-url="{{ route('guru.edit-data-soal', ['params' => $item->uuid]) }}"
                                                                                class="btn btn-primary submit-form">Save</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                    ...
                                                    <button class="btn btn-danger btn-sm button-delete"
                                                        data-url="{{ route('guru.deleted-data-soal', ['params' => $item->uuid]) }}">
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".submit-form").click(function(e) {
                ...
                formData.append('uuid_misi', $('#uuid_misi').val())
